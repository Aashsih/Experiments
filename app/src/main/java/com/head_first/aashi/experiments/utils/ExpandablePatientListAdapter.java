...
public final class ExpandablePatientListAdapter extends BaseExpandableListAdapter {
    ...
    private static final int GROUP_LAYOUT_ID = R.layout.heart_sound_ui_experiments_expandable_patient_list_group;
    private static final int ITEM_LAYOUT_ID = R.layout.heart_sound_ui_experiments_expandable_patient_list_item;
